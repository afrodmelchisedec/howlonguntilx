...
-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('COUNTDOWN', 'ELAPSED');
...
CREATE TABLE "Event" (
    ...
    "description" TEXT,
    "targetDate" TIMESTAMP(3) NOT NULL,
    "type" "EventType" NOT NULL DEFAULT 'COUNTDOWN',
    "categoryId" TEXT,
    "categorySlug" TEXT NOT NULL DEFAULT 'leisure',
...
-- CreateIndex
CREATE UNIQUE INDEX "Timer_slug_key" ON "Timer"("slug");
