...
mkdir -p "$COMPONENTS_DIR" "$REPO_ROOT/public/images/defaults" "$REPO_ROOT/public/images/articles"
...
if [[ ! -f "$LAYOUT_FILE" ]]; then
  echo "ERROR: $LAYOUT_FILE not found -- check COMPONENTS_DIR path at top of this script."
  exit 1
fi
...
echo "Now drop your images into public/images/defaults/ as: health.jpg, finance.jpg, scam.jpg, general.jpg"
