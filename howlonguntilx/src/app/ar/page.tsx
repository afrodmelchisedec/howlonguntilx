...
export const metadata = {
  title: 'كم من الوقت تبقى؟ | HowLongUntil',
  description: 'عد تنازلي حي لأي حدث. ليس تخميناً — دقيق للثانية.',
  other: { 'dir': 'rtl' },
};
...
export default async function ArPage() {
  ...
  return (
    <div dir="rtl" className="relative overflow-hidden min-h-[520px] flex items-center"
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-20 text-center w-full">
        ...
        <h1 className="text-5xl sm:text-6xl font-black mb-4 leading-tight">{t(locale,'hero_title')}</h1>
